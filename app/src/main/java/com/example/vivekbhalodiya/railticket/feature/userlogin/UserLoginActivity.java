...
import com.example.vivekbhalodiya.railticket.feature.qrcodescanner.QRCodeScanner;
...
public class UserLoginActivity extends BaseActivity<ActivitySigninBinding, UserLoginViewModel, UserLoginView> implements UserLoginView {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    UserLoginActivity activity = this;
    binding.ticketCheckerButton.setOnClickListener(v -> startActivity(new Intent(activity, QRCodeScanner.class)));
  }
